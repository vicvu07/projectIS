...
<?php 
  ...
  $func = new Operation();  
  $task_id=$_REQUEST['task_id']; // getting taskid 
  $myId=$_SESSION['user_id']; // getttting myid

  //$sql = "SELECT * FROM task WHERE task_id = '".$task_id."'"; //  query will fetch task details by task id  
  ...
  while($row = $result1->fetch_assoc())
  {
    ...
    $myName=$row["user_fname"].$row["user_lname"] ;
             ...
             <div class = "card">
              <div class = "card-body">
                ...
                <form method="GET">
                        ...
                        <div class="form-group">
                          <label >Task Sender</label>
                          <input class="form-control" type="text" name="tasksender" value =" <?php echo "$taskSender"; ?>" readonly/>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" onchange="update_task_status(this.value,<?php echo $task_id;?>)">
