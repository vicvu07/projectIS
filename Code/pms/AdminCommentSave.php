...
{                           
 ...
 $result = $func->insert('comments',array('comment_text','comment_by','comment_to','comment_task_id','commenter_name','commenter_image','comment_time'),array("'$commentText'","'$mineId'","'$recId'","'$task_id'","'$mineName'","'$mineImage'","'$commentTime'"));
